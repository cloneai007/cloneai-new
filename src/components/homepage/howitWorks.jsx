...
export default function HowitWorks({onCalenderOpen}) {
  ...
  return (
    <Grid container spacing="2" width={"100%"} >
      <Grid item xs={12} display="flex" justifyContent={"center"} mt="40px" mb="60px">
        <Typography
          variant="h1"
      ...
      <Grid item xs={12} display="flex" alignItems={"center"} mb="30px">
        ...
        <Grid item xs={6} display="flex" justifyContent={"center"} mt="30px" mb="20px">
      ...
      <Grid item xs={12} display="flex" alignItems={"center"} mb="30px" width={"80%"}>
      ...
      <Grid item xs={6} display="flex" justifyContent={"center"} mt="30px" mb="20px">
          <Box justifyContent={"center"} width="80%">
            ...
            <Typography
              ...
              sx={{ m: "0 0 5px 0" }}
            >
              Unlike hedge funds and other old-style “alternative” investments, you don’t hand over your money to anyone. Certainly not to us. Your money stays inside your brokerage account at all times. You “turn on” our strategy inside your brokerage account.
            </Typography>
      ...
      <Grid item xs={12} display="flex" justifyContent={"center"} mt="60px" mb="40px" >
        <Button
