...
const PrivacyPage = () => {
  ...
  const terms = [
    ...
    {
      title: "4. Cookies",
      content: "Clone Ai LLC may set and access Clone Ai LLC cookies on your computer. Advertisers or other companies do not have access to Clone Ai LLC’s cookies. Your data is not shared with any parties."
    },
    {
  ...
  return (
    <Box m="20px" ml={{ xl: "100px", xs: "10px" }} mr={{ xl: "100px", xs: "10px" }}
      justifyContent={"center"} display="content"
      minWidth={"400px"}>
      ...
      <Box mb="30px" display="flex">
        <Grid container spacing={2} alignItems="center" >
          ...
          <Grid item xl={4} xm={12} xs={12}
            justifyContent={{ xl: "space-between", xm: "space-between", xs: "space-evenly" }}
            display="Flex">

          </Grid>

          <Grid item xl={4} xm={4} xs={12}
      ...
      <Grid container spacing="2" justifyContent={"center"} mt="100px" display={"flex"}>
      ...
      <Box display="flex" justifyContent="center" alignItems="center" mt="100px" ref={ContactRef}>
        <Contact />
      </Box>
